...
C-a <                           # Display window menu
C-a =                           # Choose a paste buffer from a list
C-a >                           # Display pane menu
C-a ?                           # List key bindings
C-a C                           # Customize options
C-a D                           # Choose and detach a client from a list
...
C-a M-6                         # Set the main-horizontal-mirrored layout
C-a M-7                         # Set the main-vertical-mirrored layout

...
El panel derecho muestra una previsualización. Una vez abierto un `.md`, usá `/` o `?` para buscar dentro del documento, `n`/`N` para recorrer coincidencias y `q` para volver al hub.
